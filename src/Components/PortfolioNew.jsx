    ...
    >
      ...
      <div className="w-full mt-64 mx-auto">
        <div className="flex flex-col sm:flex-row justify-evenly gap-16 w-[90%] mx-auto">
          ...
          <button className="p-6 bg-gradient-to-r from-purple-700 via-blue-500 to-purple-400 rounded-lg text-black font-bold hover:scale-110 duration-300"><a href="images/postman_collection.json" download="postman_collection.json" target="_blank" rel="noreferrer" className="flex justify-center items-center gap-2"><SiPostman className="w-8 h-8"/> Postman Collection Download</a></button>
        </div>
      </div>
    </div>
  );
